...
한 세그먼트 누르면 바로 직전꺼 마지막 거의 한 0.1 초부터 시작함.. 듣는데는 문제 없지만 세그먼트 강조가 순식간에 바뀌니까 불편함.
세그먼트 왼쪽에 <, > 이런 버튼으로 해당 문장 시작점을 0.1 초 단위로 움직일 수 있으면 좋겠음. 마우스가 크게 이동은 편한데 미세한 조정이 어려움.